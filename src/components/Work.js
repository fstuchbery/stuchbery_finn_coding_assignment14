    ...
    <section id="work">
      ...
      <div>
        ...
        <p>
          ...
          Stuchbery_Finn_coding_assignment11, and the site files were hosted in
          a working directory called Stuchbery_Finn_site.
        </p>
      </div>
      <div>
        ...
        <p>
          ...
          named Stucbery_Finn_coding_assignment12 to host the production build
          of the app, and the site files were stored in a directory called
          Stuchbery_Finn_ui_garden.
        </p>
      </div>
      <div>
        ...
        <p>
          ...
          named Stuchbery_Finn_coding_assignment13. The site files were stored
          in a directory called Stuchbery_Finn_ui_garden_build_checks. I also
